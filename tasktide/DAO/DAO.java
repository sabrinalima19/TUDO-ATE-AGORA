...
public class DAO extends SQLiteOpenHelper {
    ...
    public Informacoes getInformacoesById(long id) {
        SQLiteDatabase db = this.getReadableDatabase();
        Informacoes informacoes = null;
        Cursor cursor = db.query(TABELA_INFORMACOES,
                new String[]{"dataPrevis", "dataFim", "horarioInicio", "horarioTermino", "prazo", "local", "valorEvento", "Pago"},
                "id_evento = ?",
                new String[]{String.valueOf(id)},
                null, null, null);
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            informacoes.setDataPrevis(cursor.getString(cursor.getColumnIndexOrThrow("dataPrevis")));
            informacoes.setDataFim(cursor.getString(cursor.getColumnIndexOrThrow("dataFim")));
            informacoes.setHorarioInicio(cursor.getString(cursor.getColumnIndexOrThrow("horarioInicio")));
            informacoes.setHorarioFim(cursor.getString(cursor.getColumnIndexOrThrow("horarioTermino")));
            informacoes.setPrazo(cursor.getString(cursor.getColumnIndexOrThrow("prazo")));
            informacoes.setLocal(cursor.getString(cursor.getColumnIndexOrThrow("local")));
            informacoes.setValorEvento(cursor.getDouble(cursor.getColumnIndexOrThrow("valorEvento")));
            informacoes.setPago(cursor.getString(cursor.getColumnIndexOrThrow("Pago")));
            cursor.close();
        }
        db.close();
        return informacoes;
