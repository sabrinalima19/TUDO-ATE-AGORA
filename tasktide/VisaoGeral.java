...
public class VisaoGeral extends AppCompatActivity {
    ...
    private TextView txtMostraTipoDoEvento, edtxtMostraPrazoInscricao;
    private ImageButton imgbtnEditarValorEvento;
    private TextView txtMostraHorasComplementaresEvento, txtHoraDeInicioEvento, txtHoraDeTerminoEvento, txtValorDoEvento,edtxtMostrarValorDoEvento;
    private DAO dao;
    ...
    private void preencherCamposComDadosDoEvento(long idEvento) {
        ...
        if (evento != null) {
            ...
            if (informacoes != null) {
                ...
                txtMostraDataDoEvento.setText(informacoes.getDataPrevis());
